        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our team reviews each recipe to ensure quality and authenticity.
                This helps maintain our high standards and keeps our community
                safe.
              </p>
            </div>
            <div className="text-center group">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              ...
              favorite recipes. Your next favorite dish might be just one recipe
              away!
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 leading-relaxed">
                Bringing food lovers together through the joy of sharing recipes
